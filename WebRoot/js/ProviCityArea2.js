...
var addressInit2 = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{    
	//alert(_cmbProvince+"   "+_cmbCity+" "+_cmbArea+"  "+defaultProvince+"  "+defaultCity+"  "+defaultArea);

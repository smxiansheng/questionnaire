                 ...
                 <li ><a href="main-stats.php">经营主体类型</a></li>
                  <li ><a href="product-stats.php">生产方式</a></li>
                   <li ><a href="record-stats.php">学历</a></li>
                    <li  class="active"><a href="policy-stats.php">政策保险及金融保险</a></li>
        ...
        <div class="span9">
		  <div class="row-fluid">
			...
			<div class="page-search">
				<form action="policy-stats1.php" method="POST">
				...
				<!--<input type="button" id="soub" value="新建信息" style="width: 50px;position: relative;float: right;left: -100px;" />-->
					<a href="new-policy.html" class="btn btn-success" style="position: relative;float: right;left: -100px;">新建信息</a>
        </form>
			...
			<table class="table table-striped table-bordered table-condensed">
				<thead>
					<tr>
						...
						<th style="width: 60px;">政策保障及金融保险</th>
                ...
                $sql="SELECT * FROM b_zcbzjjrbx WHERE zcbzmc = '".$lxname."'";
...
?>
				...
				<tr class="list-roles" >
					<td><?php  echo $row['zcbzid']  ?></td>
					<td><?php  echo $row['zcbzmc']  ?></td>

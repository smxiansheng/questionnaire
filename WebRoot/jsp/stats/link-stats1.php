          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li ><a href="stats.php">蔬菜种类</a></li>
                ...
                <li class="active"><a href="link-stats.php">经营环节</a></li>
        ...
        <div class="span9">
		  <div class="row-fluid">
			...
			<div class="page-search">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="id" name="id" placeholder="请输入ID" style="width: 300px;" />&nbsp;
				...
				<!--<input type="button" id="soub" value="新建信息" style="width: 50px;position: relative;float: right;left: -100px;" />-->
					<a href="new-link.html" class="btn btn-success" style="position: relative;float: right;left: -100px;">新建信息</a>
        </form>
			...
			<table class="table table-striped table-bordered table-condensed">
                ...
                $sql="SELECT * FROM b_jyhj WHERE jyhjmc = '".$lxname."'";
...
?>
				...
				<tr class="list-roles" >
					<td><?php  echo $row['jyhjId']  ?></td>
					<td><?php  echo $row['jyhjmc']  ?></td>

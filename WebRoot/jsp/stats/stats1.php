...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>用户管理 绿色简洁Bootstrap响应式后台管理模板</title>	
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="stats.html">蔬菜种类</a></li>
        ...
        <div class="span9">
		  <div class="row-fluid">
			...
			<div class="page-search">
				<form action="stats1.php" method="POST">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="lxname" name="lxname" value="<?php echo $_POST['lxname']?>"  placeholder="请输入名称" style="width: 300px;" />&nbsp;
				...
				<!--<input type="button" id="soub" value="新建信息" style="width: 50px;position: relative;float: right;left: -100px;" />-->
					<a href="new-infors.html" class="btn btn-success" style="position: relative;float: right;left: -100px;">新建信息</a>
        </form>
			...
			<table class="table table-striped table-bordered table-condensed">
				...
				$lxname=$_POST['lxname'];
                 ...
                 if(($lxname!=null) && ($lxname!="")){
                	$sql="SELECT * FROM b_sclx where scmc='".$lxname."'";
...
?>
				...
				<tr class="list-roles" >
					...
					<td><?php  echo $row['scmc']  ?></td>
				
					<td>
						<div class="btn-group">
							<!-- <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">编辑<span class="caret"></span></a>
							<ul class="dropdown-menu pull-right"> -->
								<li><a href="#"><i class="icon-trash"></i><input type="button" name="delete"  value="删除" onclick="del(this);" /></a></li>
							<!-- </ul> -->
						</div>
					</td>

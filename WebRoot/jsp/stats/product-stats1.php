              ...
              <li ><a href="stats.php">蔬菜种类</a></li>
                ...
                <li><a href="link-stats.php">经营环节</a></li>
                 <li ><a href="main-stats.php">经营主体类型</a></li>
                  <li  class="active"><a href="product-stats.php">生产方式</a></li>
        ...
        <div class="span9">
		  <div class="row-fluid">
			...
			<div class="page-search">
				<form action="product-stats1.php" method="POST">
			...
			<table class="table table-striped table-bordered table-condensed">
                ...
                $sql="SELECT * FROM b_scfs WHERE scfsmc = '".$lxname."'";
...
?>
				...
				<tr class="list-roles" >
					<td><?php  echo $row['scfsId']  ?></td>
					<td><?php  echo $row['scfsmc']  ?></td>

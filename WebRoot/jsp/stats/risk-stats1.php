          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li ><a href="stats.php">蔬菜种类</a></li>
                <li  class="active"><a href="risk-stats.php">经营风险</a></li>
        ...
        <div class="span9">
		  <div class="row-fluid">
			...
			<div class="page-search">
				<form action="risk-stats1.php" method="POST">
				...
				<!--<input type="button" id="soub" value="新建信息" style="width: 50px;position: relative;float: right;left: -100px;" />-->
					<a href="new-risk.html" class="btn btn-success" style="position: relative;float: right;left: -100px;">新建信息</a>
        </form>
			...
			<table class="table table-striped table-bordered table-condensed">
                ...
                $sql="SELECT * FROM b_jyfx WHERE jyfxmc = '".$lxname."'";
...
?>
				...
				<tr class="list-roles" >
					<td><?php  echo $row['jyfxId']  ?></td>
					<td><?php  echo $row['jyfxmc']  ?></td>

		...
		<table class="table table-striped table-bordered table-condensed">
				...
				<thead>
					<tr>
						...
						<th style="width: 100px;">技术类型</th>
						<th style="width: 100px;">现有技术评价</th>
						<th style="width: 100px;">新技术需求评价</th>
		...
		$.ajax({
			...
			success:function(res){
				...
				for (var x=0;x<res.length;x++){
					...
					trans(res[x].techType)+"</td><td>"+
					trans(res[x].techAssess)+"</td><td>"+
					trans(res[x].needAccess)+"</td>";
					r="<tr>"+r+"</tr>";
					$("#bo").append(r);
				}
			}

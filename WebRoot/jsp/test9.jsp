...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<div class="page-header">
			...
			<div class="page-search">
				...
				<input type="button" onclick="searchTechnologyByName()"  name="soub" value="搜索" style="width: 50px;" />
					<a href="#" id="new-4" class="btn btn-success" style="position: relative;float: right;left: -100px;">新建信息</a>
        </form>
			...
			<table class="table table-striped table-bordered table-condensed" id="deleteId">
				<thead>
					<tr>
						...
						<th style="width: 60px;">技术名称</th>
						<th style="width: 50px;">编辑</th>
					</tr>
				</thead>
				 <tr class="list-roles" id="all">
					<tbody   id="TechnologyXianShi">
...
function searchTechnologyByName(){
	  var str=$("#lxname").val();
	  /* $("#f").click(); */
	  test9Jsp();
	  $.ajax( {
			type :"post",
			url :"${path}/searchTechnologyByName.do",
			data:{"str": str},
			dataType : "json",
			success : function(data) {
			  $.each(data,function(i,BJslx) {
                    var cc = "";
                       cc+='<tr height="50"><td>'+BJslx.jslxid+"</td><td>"+BJslx.jslxmc+"</td>";
